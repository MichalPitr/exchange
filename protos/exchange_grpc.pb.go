...
const (
	OrderService_SendOrder_FullMethodName = "/exchange.OrderService/SendOrder"
)
...
func (c *orderServiceClient) SendOrder(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*OrderResponse, error) {
	out := new(OrderResponse)
	err := c.cc.Invoke(ctx, OrderService_SendOrder_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedOrderServiceServer) SendOrder(context.Context, *OrderRequest) (*OrderResponse, error) {
...
func _OrderService_SendOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).SendOrder(ctx, req.(*OrderRequest))
	}
